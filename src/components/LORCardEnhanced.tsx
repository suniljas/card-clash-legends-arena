          ...
          <div className="flex-1 mx-3 mb-3 rounded-md overflow-hidden relative border-2 border-slate-600 shadow-inner">
            ...
            {rarityConfig.holographicIntensity > 0 && (
              <div className="absolute inset-0 pointer-events-none">
                <div 
                  className={cn(
                    "absolute inset-0 bg-gradient-to-br from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  )}
                  style={{ opacity: rarityConfig.holographicIntensity }}
                />
                <div 
                  className={cn(
                    "absolute inset-0 bg-gradient-to-r from-transparent via-white/15 to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1500"
                  )}
                  style={{ opacity: rarityConfig.holographicIntensity }}
                />
                <div 
                  className={cn(
                    "absolute inset-0 bg-gradient-to-br from-transparent via-white/10 to-transparent animate-pulse"
                  )}
                  style={{ opacity: rarityConfig.holographicIntensity }}
                />
              </div>
